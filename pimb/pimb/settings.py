"""
Django settings for pimb project.
...
SECRET_KEY = 'django-insecure-=!09bypit#6#650gk^=i_v57-kt($l2n(9xfgb6kqn*h!cjhj*'
...
WSGI_APPLICATION = 'pimb.wsgi.application'
...
AUTH_USER_MODEL = 'utilisaturs.Utilisateur'
